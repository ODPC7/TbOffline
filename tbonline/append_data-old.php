...
//+++	ตรวจสอบว่ามี่การส่งค่ามาหลังจากการ แก้ไขข้อมูล หรือไม่
	if (! isset($_GET["pt_name"]) and ! isset($_GET["cno"]))	{
		...
		if (isset($_GET["edit"]))	{
			...
			<p>เลขบัตรประชาชน : <input type='text' name='id_card' size='12' maxlength='13' value='$_id' autocomplete='off'> $space
		...
		if (isset($_POST["keyword"]))	{
			...
			<p>เลขบัตรประชาชน : <input type='text' name='id_card' size='12' maxlength='13' autocomplete='off'> $space
					ชื่อ - สกุล : <input type='text' name='fname' value='$keyword'  autocomplete='off'> $space
