...
$show_rec =mysql_fetch_array($sql_iden);
	$iden_result =$show_rec["result"];
		if ($iden_result=='MTB')	{
			$show_iden_result ="Mycobacterium Tuberculosis";
		}else{
			if ($iden_result=='NTM')	{
				$show_iden_result ="NonTuberculosis Mycobacterium";
			}else{
				$show_iden_result ="Not Done";
			}
		}
...
print "<p style='font-size:0.9em; border:1px solid #000; padding:0.75rem;'>
Identification Result : <b>$show_iden_result</b>	
ผู้รายงานผล : $iden_reporter  วันที่รายงานผล : $iden_datereport
</p>";
